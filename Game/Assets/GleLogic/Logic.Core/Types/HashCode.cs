...
{
	/// <summary>
	/// This type is duplicated and modified from the reference Microsoft implementation as it is not available on Unity.
	/// See the original here: https://github.com/dotnet/corert/blob/c6af4cfc8b625851b91823d9be746c4f7abdc667/src/System.Private.CoreLib/shared/System/HashCode.cs
	/// </summary>
	internal struct HashCode
	{
		...
		private void Add(int value)
		{
			...
			// ReSharper disable once ConvertIfStatementToSwitchStatement - Switch can't be inlined.
			if (position == 0)
				_queue1 = val;
			else if (position == 1)
				_queue2 = val;
...
#pragma warning disable 0809
		...
		//   as this would be weird, both from a naming standpoint and from a
