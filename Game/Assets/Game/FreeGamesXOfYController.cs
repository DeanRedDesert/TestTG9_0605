...
namespace Game
{
	public sealed class FreeGamesXOfYStatus : StatusBlock
	{
		#region Fields
		...
		public FreeGamesXOfYStatus(string name) : base(name)
		{
		}
	...
	public sealed class FreeGamesXOfYController : IPresentationController
	{
		#region Fields
		...
		public static FreeGamesXOfYStatus Data { get; private set; }

		#endregion

		#region Constructor

		public FreeGamesXOfYController(Stage stage)
		{
			this.stage = stage;
			Data = new FreeGamesXOfYStatus($"{this.stage.Name}XOfYStatus");
