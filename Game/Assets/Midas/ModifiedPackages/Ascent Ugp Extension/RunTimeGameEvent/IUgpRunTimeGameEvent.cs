//-----------------------------------------------------------------------
// <copyright file = "IUgpRunTimeGameEvent.cs" company = "IGT">
...
{
    /// <summary>
    /// Defines an interface that allows a package to notify the foundation about run time game events.
    /// </summary>
    public interface IUgpRunTimeGameEvent
    {
        ///<summary>
