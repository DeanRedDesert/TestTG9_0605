namespace Midas.Core
{
	public enum MoneyEvent
	{
		...
		/// been committed. This can happen for mid-game bets. Normal starting bets will result in a <see cref="MoneyCommittedChanged"/> event instead.
		/// </summary>
		MoneyBet,

		/// <summary>
		/// Notification of the outcome list wins being reflected in the player meters.
		/// </summary>
		MoneyWon,
		...
		/// <summary>
		/// Notification of the money transfer between the player wagerable meter and the player bank meter.
		/// </summary>
		MoneyWagerable,
