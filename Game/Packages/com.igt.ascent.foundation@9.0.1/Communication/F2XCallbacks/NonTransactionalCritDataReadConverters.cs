// -----------------------------------------------------------------------
// <copyright file = "NonTransactionalCritDataReadConverters.cs" company = "IGT">
...
namespace IGT.Game.Core.Communication.Foundation.F2XCallbacks
{
    ...
    using F2X.Schemas.Internal.NonTransactionalCritDataRead;
    using F2X.Schemas.Internal.Types;

    /// <summary>
    /// Collection of extension methods helping convert between interface type
    /// CriticalDataScopeType and F2X schema type NonTransactionalCritDataRead.ItemChoiceType.
    /// </summary>
    public static class NonTransactionalCritDataReadConverters
    {
        /// <summary>
        /// Converts a <see cref="CriticalDataSelector"/> to a F2X <see cref="CriticalDataItemSelector"/>.
        /// </summary>
        ...
        /// </exception>
        public static CriticalDataItemSelector ToNonTransactionalCriticalDataItemSelector(
            this CriticalDataSelector criticalDataSelector)
        {
            ...
            var criticalDataItemSelector = new CriticalDataItemSelector
            {
                ...
                ItemElementName = criticalDataSelector.Scope.ToNonTransReadScopeType()
            };
        ...
        /// <summary>
        /// Converts a F2X <see cref="CriticalDataItemSelector"/> to a <see cref="CriticalDataSelector"/>.
        /// </summary>
            ...
            switch(criticalDataItemSelector.ItemElementName)
            {
                ...
                default:
                    throw new ArgumentException(
                        $"The scope {criticalDataItemSelector.ItemElementName} is not supported to accessing critical data non-transactionally.", nameof(criticalDataItemSelector));
            }
