...
namespace IGT.Game.Core.Registries.Internal.F2X.F2XReportRegistryVer2
{
    ...
    [XmlTypeAttribute(AnonymousType=true, Namespace="F2XReportRegistryVer2.xsd")]
    [XmlRootAttribute(Namespace="F2XReportRegistryVer2.xsd", IsNullable=false)]
