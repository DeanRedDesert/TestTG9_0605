//-----------------------------------------------------------------------
// <copyright file = "GameLogicAutomationErrorMsg.cs" company = "IGT">
...
namespace IGT.Game.Core.Communication.GL2PInterceptorLib
{
    ...
    /// </summary>
    [Serializable]
    public class GameLogicAutomationErrorMsg : AutomationGenericMsg
    {
        /// <summary>
        /// Empty Constructor required for certain types of serialization.
        /// </summary>
        private GameLogicAutomationErrorMsg() { }

        /// <summary>
        /// Constructor for GameLogicAutomationErrorMsg.
        /// </summary>
        ...
        public GameLogicAutomationErrorMsg(InterceptorError errorType, string errorDescription)
        {
