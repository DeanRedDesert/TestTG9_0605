//-----------------------------------------------------------------------
// <copyright file = "PresentationAutomationErrorMsg.cs" company = "IGT">
...
namespace IGT.Game.Core.Communication.GL2PInterceptorLib
{
    ...
    /// </summary>
    [Serializable]
    public class PresentationAutomationErrorMsg : AutomationGenericMsg
    {
        /// <summary>
        /// Empty Constructor required for certain types of serialization.
        /// </summary>
        private PresentationAutomationErrorMsg() { }

        /// <summary>
        /// Constructor for PresentationAutomationErrorMsg.
        /// </summary>
        ...
        public PresentationAutomationErrorMsg(InterceptorError errorType, string errorDescription)
        {
