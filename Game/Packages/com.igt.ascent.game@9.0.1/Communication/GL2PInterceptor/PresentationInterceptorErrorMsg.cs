//-----------------------------------------------------------------------
// <copyright file = "PresentationInterceptorErrorMsg.cs" company = "IGT">
...
namespace IGT.Game.Core.Communication.GL2PInterceptorLib
{
    ...
    /// <summary>
    /// Message object that is comprised of the parameters of the IPInterceptorService
    /// interface function SendErrorMessage.
    /// </summary>
    [Serializable]
    public class PresentationInterceptorErrorMsg : InterceptorGenericMsg
    {
        /// <summary>
        /// Empty Constructor required for certain types of serialization.
        /// </summary>
        private PresentationInterceptorErrorMsg() { }

        /// <summary>
        /// Constructor for PresentationInterceptorErrorMsg.
        /// </summary>
        ...
        /// </param>
        /// <exception cref="ArgumentException">Thrown if errorDescription is empty or null.</exception>
        public PresentationInterceptorErrorMsg(InterceptorError errorType, string errorDescription)
        {
