//-----------------------------------------------------------------------
// <copyright file = "IGameLogicInterceptorService.cs" company = "IGT">
...
namespace IGT.Game.Core.Communication.GL2PInterceptorLib
{
    ...
    /// <summary>
    /// Defines API for a Game Logic Service that relays standard Game Logic
    /// communication to an external applications.
    /// </summary>
    public interface IGameLogicInterceptorService : IGameLogic
    {
        /// <summary>
        ...
        /// </summary>
        event EventHandler<GameLogicMessageEventArgs> MessageReceivedForProcessing;
    }
}
