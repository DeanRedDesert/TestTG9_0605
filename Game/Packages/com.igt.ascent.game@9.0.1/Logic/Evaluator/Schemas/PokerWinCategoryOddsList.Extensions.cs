// -----------------------------------------------------------------------
// <copyright file = "PokerWinCategoryOddsList.Extensions.cs" company = "IGT">
...
namespace IGT.Game.Core.Logic.Evaluator.Schemas
{
    ...
    /// <summary>
    /// Extensions to the PokerWinCategoryOddsList class.
    /// </summary>
    public partial class PokerWinCategoryOddsList : ICompactSerializable
    {
        ...
        public void Deserialize(Stream stream)
        {
            ...
            betRange = CompactSerializer.ReadEnum<PokerWinCategoryOddsListBetRange>(stream);
