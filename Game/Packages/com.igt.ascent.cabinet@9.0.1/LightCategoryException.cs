//-----------------------------------------------------------------------
// <copyright file = "LightCategoryException.cs" company = "IGT">
...
namespace IGT.Game.Core.Communication.Cabinet
{
    ...
    /// </summary>
    public class LightCategoryException : CabinetCategoryExceptionBase
    {
        /// <summary>
        ...
        public LightCategoryException(string errorCode, string description)
