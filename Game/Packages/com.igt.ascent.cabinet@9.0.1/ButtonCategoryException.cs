//-----------------------------------------------------------------------
// <copyright file = "ButtonCategoryException.cs" company = "IGT">
...
namespace IGT.Game.Core.Communication.Cabinet
{
    ...
    /// </summary>
    public class ButtonCategoryException : CabinetCategoryExceptionBase
    {
        /// <summary>
        ...
        public ButtonCategoryException(string errorCode, string description)
